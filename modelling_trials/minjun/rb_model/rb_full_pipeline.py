"""
MINJUN'S FULL PIPELINE - RB PREDICTION MODEL
...
print("="*80)
print("MINJUN'S FULL PIPELINE - RB MODEL")
...
df = pd.read_csv('rb_data_engineered.csv')

# Load feature importance for selection
feat_imp = pd.read_csv('rb_feature_importance.csv')
...
# Save ensemble
with open('rb_ensemble_model.pkl', 'wb') as f:
    pickle.dump(stacking_model, f)
print("\n✅ Saved: rb_ensemble_model.pkl")

# Save individual models
with open('rb_xgb_final.pkl', 'wb') as f:
    pickle.dump(xgb_model, f)
with open('rb_lgb_final.pkl', 'wb') as f:
    pickle.dump(lgb_model, f)
with open('rb_cat_final.pkl', 'wb') as f:
...
results_df.to_csv('rb_ensemble_predictions.csv', index=False)
print("✅ Saved: rb_ensemble_predictions.csv")

# Save final features
with open('rb_final_features.txt', 'w') as f:
    f.write("Final 35 Features Used:\n")
    f.write("="*50 + "\n")
    for i, feat in enumerate(final_features, 1):
        f.write(f"{i:2d}. {feat}\n")
print("✅ Saved: rb_final_features.txt")
