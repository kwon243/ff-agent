...
top20_features = {
    ...
    #QB traits & usage
    "Age", "game_num", "COM%", "PA", "YPA", "ADOT", "ATT", "1ST", "TD", "TA", "PRSH",
    #Opponent & context
    "PRSH_opponent", "RUN_opponent", "COV_opponent", "RDEF_opponent", "PBLK_opponent", "RBLK_opponent", "PA_opponent", "PASS_opponent", "TACK_opponent", "DEF_opponent", "OVER_opponent", "PF_opponent",
    #context
    "NFL", "RUN_TEAM", "PASS_TEAM", "OFF_opponent",
    #Rolling signals were removed

}
#what to replace in either/or (1st over 2nd)W
PAIR_PREFS = [("PASS_opponent","OFF_opponent"),  # keep PASS_opponent over OFF_opponent
              ("YPA","PA")]                      
...
all_preds_df.to_csv(f"qb_predictions_{TARGET_YEAR}_all_models_long.csv", index=False)
print(f"\nSaved qb_predictions_{TARGET_YEAR}_all_models_long.csv")
...
qb_wide.columns.name = None

qb_wide.to_csv(f"qb_predictions_{TARGET_YEAR}_all_models_wide.csv", index=False)
print(f"Saved qb_predictions_{TARGET_YEAR}_all_models_wide.csv")
...
# ============================================================
# GPT generated: STATIC SEASON-LONG QB MODELS FOR GYM (5-year weighted)
# ============================================================


print("\n=== Training static (season-long) QB models for gym use ===")
...
prefix = "qb"  # filenames: wrte_ridge.pkl, wrte_randomforest.pkl, etc.
...
print("\nFinished training + saving static QB models.")
